				...
				<div class="panel panel-default">
			        ...
			        <ul id="sortable" class="col-md-12 list">
			          	...
			          	<li id="listItem_{{$category->id}}" class="col-md-12 item-category" style="padding-bottom: 5px; padding-top: 5px;">
			          		...
			          		<div class="col-md-2" >
			          			<div class="row" style="display: block; width: 75px; margin: 0 auto;     height: 25px;">
									<div class="col-sm-4 iSwitch flat-switch">
										<div class="switch">
											<input name="state" class="state" value="{{$category->id}}" type="checkbox" @if($category->state==1) checked @endif @if(Menu::state($category->id)!=true) disabled @endif>
										</div>
									</div>
								</div>
			          		</div>
			          		...
			          		<div class="col-md-1">
			          		     <img src="@if(Menu::state($category->id)==true) {{url('assets/img/active.png')}} @else {{url('assets/img/no-active.png')}} @endif" width="35px" height="35px" style="display: block; margin: 0 auto;">
			          		</div>
			          	</li>
			          	@endforeach					
			          </ul>

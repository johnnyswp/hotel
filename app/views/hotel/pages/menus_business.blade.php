	...
	<div class="row">
		...
		<section class="panel">
			<header class="panel-heading sm" data-color="theme-inverse">
				<h2><strong>{{trans('main.business menu')}}</strong></h2>
			...
			<div class="panel-body">
				<div class="form-group">
					<div>
						<a href="{{url('hotel/business/menu/create')}}" class="btn btn-theme">{{trans('main.nuevo')}} {{trans('main.menu de negocio')}}</a>
					</div>
				</div>
				...
				<div class="panel panel-default">
			        ...
			        <ul id="sortable" class="col-md-12 list">
			          	...
			          	<li id="listItem_{{$menu->id}}" class="col-md-12 item-category" style="padding-bottom: 5px; padding-top: 5px;">
			          		...
			          		<div class="col-md-1">
			          		    <a href="{{url('hotel/business/menu/'.$menu->id.'/edit')}}" type="button" class="btn btn-md btn-primary"><span class="glyphicon glyphicon-pencil" aria-hidden="true" style="color: white;"></span></a>
			          		</div>
			          		<div class="col-md-1">
                                ...
                                <div id="form_notice_{{$menu->id}}" style="display: none;">
                                  {{ Form::open(array('class'=>'pf-form pform_custom','url' => 'hotel/business/menu/'.$menu->id)) }}

	...
	<div class="row">
		...
		<section class="panel" style="" >
			<header class="panel-heading sm" data-color="theme-inverse">
				<h2><strong>{{trans('main.nuevo')}}</strong> {{trans('main.order')}}</h2>
                   ...
                   <div class="form-group" style="width: 300px;">
                    ...
                    <div class="form-group" style="width: 300px;">
                        ...
                        <div>
                            ...
                            {{ Form::text('fecha', $order->delivery_time->format('d-m-Y H:i:s')  , ['class' => 'form-control start-date', 'required'=>'required']) }}
                    ...
                    <table class="table table-bordered" id="sector_table">
                      ...
                      @foreach($itemsOrders as $itemOrder)
                        ...
                        <tr id="item-order-{{$itemOrder->id}}">
                          ...
                          <td>{{Hotel::find(Hotel::id())->exchanges->symbol}} <span id="sub-total-{{$itemOrder->id}}">{{round($itemOrder->price*$itemOrder->quantity, 2)}}</span></td>

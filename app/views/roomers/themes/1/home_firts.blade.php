...
<div id="welcome" class="col s12 m8 offset-m2">
	<div class="card-panel teal box " style="position:relative">
		...
		<div class="row" style="margin-top:20px">
			 ...
			 <a href="/roomer/category-info-list"    class="text-catg waves-effect waves-white flow-text col s5 "><span>  {{$lang->txt_informacion_de_alrededores}} </span><i class="fa fa-info-circle fa-5x" aria-hidden="true"></i></a>
		</div>	

            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FAF7EA">
               ...
               <tr>
                  <td align="center" style="background-color: #f8f8f8; ">
                     <table class="table600" height="175" bgcolor="#f8f8f8" border="0" cellspacing="0" cellpadding="0" style="background-color: #f8f8f8; ">
                        ...
                        <!-- content -->
                         <tr>
                           <td align="center" style="font-family: Arial, Helvetica, sans-serif;font-size:14px; color:#adadad; line-height:24px;">                               
                              {{trans('main.password reminder')}} easyroomservice.com. 
                              <br>{{trans('main.to recover your password click the following link')}}: {{ URL::to('reset_password', array($token)) }}
                           </td>
                        </tr>
                        <!-- end content -->
                           ...
                           <td>
                              <table width="230" border="0" align="center" cellpadding="0" cellspacing="0">
                                 <tbody><tr>
                                    <td>
                                       <!-- button -->
                                       <a style="font-family: Arial, Helvetica, sans-serif; font-size:14px; color:#ffffff;" href="{{URL::to('reset_password', array($token))}}">
                              ...
                              <table class="table-inner" width="600" border="0" cellspacing="0" cellpadding="0">
                                 <tr>
                                    <td align="center" style="font-family: Helvetica, Arial, sans-serif; font-size:12px ; color:#999999; padding:0px 35px; line-height:20px;">
                                       ...
                                       <a href="#" style="color:#009ce7; text-decoration:none">altas@easyroomservices.com</a>
                                    </td>
                                 </tr>
                                 <!-- end notification -->
                                 <tr>
                     ...
                     <table class="table600" width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tbody><tr>
                           <td height="30" align="center" bgcolor="#e1e1e1" style="font-family: Helvetica, Arial, sans-serif; font-size:11px; color:#6b6b6b;">
                              <a href="http://www.easyroomservices.com/" style="color:#009ce7; text-decoration:none;">easyroomservices, Madrid, España </a> 
                           </td>
                        </tr>
                        <tr>
                           <td height="30" align="center" bgcolor="#e1e1e1" style="font-family: Helvetica, Arial, sans-serif; font-size:11px; color:#6b6b6b;">
